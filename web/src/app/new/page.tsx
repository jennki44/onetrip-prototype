  ...
  return (
    <div className="mx-auto w-full max-w-[520px] px-5 pt-8">
      ...
      <form action={createTrip} className="flex flex-col gap-4">
        ...
        <label className="flex flex-col gap-1.5 text-[12.5px] font-extrabold text-ink-2">{t("ui.tripName")}<input name="name" required maxLength={80} className="input" placeholder="e.g. Sydney Family Trip" /></label>
