...
export default async function Memories({ params }: { params: Promise<{ tripId: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-[640px]">
      ...
      <button className="btn btn-sun mt-6 w-full py-4 text-[16px]" disabled>{t("ui.storyLater")}</button>
    </div>
  );
}
