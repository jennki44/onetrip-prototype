...
export interface TripDay { trip_id: string; day: number; theme: string | null; stay: string | null; drive: string | null; banner_url: string | null; caption: string | null; rule: string | null }
export interface Place { id: string; trip_id: string; name: string; type: PlaceType; area: string | null; address: string | null; lat: number | null; lng: number | null; map_x: number | null; map_y: number | null; rating: number | null; price_level: string | null; est_pp_minor: number | null; hours: string | null; emoji: string; photo_url: string | null; from_hotel_min: number | null; saved: boolean; created_by: string | null; created_at: string }
...
export interface Decision { id: string; trip_id: string; title: string; question: string | null; status: DecisionStatus; deadline: string | null; day: number | null; slot: string | null; category: string; confirmed_option_id: string | null; created_by: string | null; created_at: string }
export interface DecisionOption { id: string; decision_id: string; trip_id: string; place_id: string | null; label: string | null; sub: string | null; est_pp_minor: number; sort: number }
