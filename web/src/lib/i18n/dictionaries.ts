...
const en = {
  ...
  ui: {
    ...
    needMerchant: "Enter who you paid (the shop or hotel).", needAmount: "Enter the amount.", mismatch: "Items add up to {items}; the amount is {total}. {diff} still to assign.", overBy: "Items add up to {items}, which is {diff} more than the amount {total}.", addRemainder: "＋ Add the remaining {diff} as one item", youPay: "You pay", paysYou: "Pays you", between: "Between travellers", settleNote: "OneTRIP records who paid whom. Money moves through your own bank, PayID, FPS or cash — no card details are stored here.", allSettled: "Everyone is settled up.", allSettledParty: "Everyone is settled up 🎉",
...
const zhHant: Dictionary = {
  ...
  ui: {
    ...
    needMerchant: "請輸入付款俾邊個（商戶或酒店）。", needAmount: "請輸入金額。", mismatch: "各項加埋係 {items}，但金額係 {total}，仲有 {diff} 未分配。", overBy: "各項加埋係 {items}，比金額 {total} 多咗 {diff}。", addRemainder: "＋ 將餘額 {diff} 加做一項", youPay: "你要付", paysYou: "付俾你", between: "旅伴之間", settleNote: "OneTRIP 只記錄邊個付咗俾邊個。錢經你自己嘅銀行、PayID、FPS 或者現金過數 — 唔會儲存任何卡資料。", allSettled: "大家已經結清。", allSettledParty: "大家已經結清 🎉",
    ...
    map: { all: "全部", today: "今日", food: "飲食", activities: "活動", bookings: "預訂", saved: "已儲存", inTrip: "呢個行程入面", notInPlan: "未加入行程。", suggest: "🗳 提議", addToPlan: "📅 加入行程", fromStay: "距離住宿 {n} 分鐘", open: "營業 {hours}", saved2: "💚 已儲存", mapSub: "行程入面所有地點 — 住宿、飲食、活動、預訂同儲存咗嘅構思。", navigate: "🧭 導航", navigateSub: "用 Google 地圖由你而家嘅位置開始導航。", noCoords: "呢個地點未有地圖位置。", locate: "📍 我", locating: "搵緊你…", locateDenied: "呢個網站嘅定位已被封鎖。請喺手機設定（Safari 或 Chrome → 位置）允許，然後再試。", locateFail: "攞唔到你嘅位置。請確認已開啟定位服務同有訊號，然後再試。", km: "{n} 公里" },
