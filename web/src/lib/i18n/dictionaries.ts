...
const en = {
  ...
  ui: {
    ...
    inboxNote: "Automatic reading of bookings and receipts arrives with the AI milestone. Today, files are stored and linked, and bookings are typed in.", mapNote: "Schematic map for now. Street maps with routing arrive with the mapping milestone.",
...
const zhHant: Dictionary = {
  ...
  ui: {
    ...
    inboxNote: "自動讀取預訂同收據會喺 AI 階段推出。而家文件會儲存同連結，預訂就手動輸入。", mapNote: "暫時係示意地圖。街道地圖同路線會喺地圖階段推出。",
    ...
    map: { all: "全部", today: "今日", food: "飲食", activities: "活動", bookings: "預訂", saved: "已儲存", inTrip: "呢個行程入面", notInPlan: "未加入行程。", suggest: "🗳 提議", addToPlan: "📅 加入行程", fromStay: "距離住宿 {n} 分鐘", open: "營業 {hours}", saved2: "💚 已儲存", mapSub: "行程入面所有地點 — 住宿、飲食、活動、預訂同儲存咗嘅構思。" },
